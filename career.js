// ==================== career.js (v3 - FORMATION FIX, PRO BROADCAST, OPEN PLAY, LIVE STATS) ====================
(function() {
    'use strict';
    ...
    // --- 5. EUROPEAN COMPETITIONS (full knockout run to the final, stage by stage) ---
    ...
    // The stage is played after the league match of these matchweeks
    ...
    // League table order used for European qualification (last season's table if we have one)
    ...
    // The user still plays his European nights: he gets a rating and contributions
    ...
    let matchStatsTracker = {}; // Live stats tracked during match
    ...
    // Position-specific open-play contributions — player earns rating through organic match actions
    function registerOpenPlayAction(minute) {
        const pos = (player.position || '').toUpperCase();
        const roll = Math.random();
        
        // Initialise tracker fields
        ...
        // FORWARDS (ST, CF): shots, dribbles, hold-up play
        ...
        // ATTACKING MIDFIELDERS/WINGERS (CAM, LW, RW): through balls, dribbles, long shots
        ...
        // CENTRAL/DEFENSIVE MIDFIELDERS (CM, CDM, LM, RM): interceptions, tackles, distribution
        ...
        // DEFENDERS (CB, LB, RB): tackles, clearances, aerial duels
        ...
        // GOALKEEPER (GK): saves, claims, distribution
    ...
    function startLiveMatchSimulation(homeTeam, awayTeam) {
        ...
        // The pitch always shows the user's own team
        ...
        matchInterval = setInterval(() => {
            ...
            // Open-play player actions — the user contributes organically every few ticks
    ...
    function finishMatch(homeTeam, awayTeam, clockEl) {
        ...
        // European night after the league match of a stage week
        ...
        if (player.currentMatchWeek > MAX_WEEKS_PER_SEASON) {
            // Anything left of the European bracket is played out before the season closes
    ...
    function resetSeason() {
        ...
        // Remember the final table so European qualification for next season is earned
    ...
    function updateUI() {
        ...
        // Career rating badge next to the player name, coloured by tier
        ...
        // Home and away alternate every matchweek
