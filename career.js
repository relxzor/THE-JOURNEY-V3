// ==================== career.js (FINAL COMPLETE VERSION - WITH TROPHY SYSTEM) ====================
(function() {
    'use strict';
    ...
    function simulateDomesticCups() {
        ...
        cups.forEach(cup => {
            // Random winner from active clubs
    ...
    function checkAndAwardTrophies() {
        ...
        // Check if player's club won the league
        ...
        // Special: Player of the Season (if OVR >= 80 and team won something)
    ...
    // --- 7. STANDINGS UPDATE WITH POSITION-BASED RATIOS ---
    ...
    // --- 8. NPC MATCHES SIMULATION (COMPETITIVE) ---
    function simulateLeagueNpcMatches(currentUserHome, currentUserAway) {
        ...
        for (let i = 0; i < unplayedClubs.length - 1; i += 2) {
            ...
            // ST/CF lebih banyak goal, MID lebih banyak assist
    ...
    // --- 10. MATCH ENGINE WITH LIVE SIMULATION ---
    ...
    function startLiveMatchSimulation(homeTeam, awayTeam) {
        ...
        matchInterval = setInterval(() => {
            ...
            // Goal events with position-based ratios
            if (Math.random() < 0.035) {
                ...
                if (scoringTeam === homeTeam) homeScore++;
                else awayScore++;
    ...
    function renderTrophies() {
        ...
        let html = `
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(120px, 1fr)); gap:0.5rem; margin-bottom:1rem;">
                <div style="background:var(--bg-tertiary); padding:0.5rem; border-radius:8px; text-align:center;">
                    <div style="font-size:1.5rem;">🏆</div>
                    <div style="font-weight:700; color:var(--green-bright);">${leagueTrophies}</div>
                    <div style="font-size:0.6rem; color:var(--text-muted);">League</div>
                </div>
                <div style="background:var(--bg-tertiary); padding:0.5rem; border-radius:8px; text-align:center;">
                    <div style="font-size:1.5rem;">🏆</div>
                    <div style="font-weight:700; color:var(--green-bright);">${europeanTrophies}</div>
                    <div style="font-size:0.6rem; color:var(--text-muted);">European</div>
                </div>
                <div style="background:var(--bg-tertiary); padding:0.5rem; border-radius:8px; text-align:center;">
                    <div style="font-size:1.5rem;">🏆</div>
                    <div style="font-weight:700; color:var(--green-bright);">${domesticTrophies}</div>
                    <div style="font-size:0.6rem; color:var(--text-muted);">Domestic Cup</div>
                </div>
                <div style="background:var(--bg-tertiary); padding:0.5rem; border-radius:8px; text-align:center;">
                    <div style="font-size:1.5rem;">🏅</div>
                    <div style="font-weight:700; color:var(--green-bright);">${individualTrophies}</div>
                    <div style="font-size:0.6rem; color:var(--text-muted);">Individual</div>
                </div>
            </div>
