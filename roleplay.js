...
(function() {
    ...
    window.visitLocation = function(action) {
        const outcomes = {
            rest: { msg: 'You rested at home. Fatigue reduced & stamina restored.', fatigue: -20, stamina: 5, morale: 2 },
        ...
        if (outcome.stamina && player.attributes) {
            player.attributes.stamina = Math.min(99, (player.attributes.stamina || 40) + outcome.stamina);
        }
